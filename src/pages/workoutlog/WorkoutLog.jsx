...
const WorkoutLog = () => {
  ...
  return (
   ...
   <div className="justify-content-between d-flex"> <h1 className="text-center text-primary fw-bold">Log Workout</h1>
      <Link to={'/'}> <button className="btn btn-primary " >Back Home</button></Link></div>  
